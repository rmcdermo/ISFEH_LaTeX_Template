...
{
   \fancyhf{}
   \fancyfoot[L]{\footnotesize\sf\color{gray}\textit{Proc. of the Eighth International Seminar on Fire and Explosion Hazards (ISFEH8), pp. xx-xx}\\
...
\fancyhf{}
\chead{\small\it\color{gray} Proc. of the Eighth International Seminar on Fire and Explosion Hazards (ISFEH8)}
...
\newfont{\helvb}{phvb7t at 12pt} % helvetica narrow bold
...
\begin{center}
{\helvb Paper Title Using 12pt Arial Boldface Type and Initial Capitals}\\
\vskip\baselineskip
{\bf Student, A.\footnotemark[1], Student, B.\footnotemark[1]*, and Researcher, C.\footnotemark[2]}\\
\vskip\baselineskip
...
{\it *Corresponding author email: \href{mailto:scientist@institution1.com}{\underline{scientist@institution1.com}}}\\
\end{center}
